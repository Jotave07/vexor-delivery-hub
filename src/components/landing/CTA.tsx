...
export const CTA = () => {
  return (
    <section className="py-20 md:py-24">
      <div className="container mx-auto flex flex-col gap-8 rounded-[1.75rem] border border-border/90 bg-card px-6 py-10 shadow-card md:flex-row md:items-center md:justify-between md:px-10">
