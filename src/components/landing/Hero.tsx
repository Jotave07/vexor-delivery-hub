    ...
    <section className="relative min-h-[86svh] overflow-hidden pt-24 text-white md:pt-28">
      ...
      <div className="container relative mx-auto flex min-h-[68svh] items-center px-4 pb-20">
        <div className="max-w-3xl animate-fade-up">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/12 px-4 py-1.5 text-xs font-medium text-white backdrop-blur">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <Button variant="outline" size="xl" className="border-white/25 bg-white/10 text-white hover:bg-white/18" asChild>
          ...
          <div className="mt-12 grid max-w-2xl grid-cols-1 gap-3 text-sm text-white/76 sm:grid-cols-3">
            <span className="border-l border-accent pl-3">Sem comissao por pedido</span>
            <span className="border-l border-accent pl-3">Checkout proprio</span>
            <span className="border-l border-accent pl-3">Pedidos em tempo real</span>
          </div>
        </div>
      </div>
    </section>
