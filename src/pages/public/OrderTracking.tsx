...
const OrderTracking = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-10">
      <header className="border-b border-border bg-card p-6 text-center text-foreground">
        ...
        <div className="text-sm text-muted-foreground">Pedido #{order.order_number}</div>
      </header>
